...
const t = {
  en: {
    ...
    ratePill: "Rate: 1 USD = MK 1,734 \u00b7 July 2026 \u00b7 Contact for formal quotations",
  ...
  pt: {
    ...
    ratePill: "Taxa: 1 USD = MK 1,734 \u00b7 Julho 2026 \u00b7 Contacte para orcamentos formais",
  ...
  ny: {
    ...
    ratePill: "Mtengo: 1 USD = MK 1,734 \u00b7 Julayi 2026 \u00b7 Lumikizanani kwa quotation yovomerezeka",
